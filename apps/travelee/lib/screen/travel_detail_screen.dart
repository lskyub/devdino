...
class _TravelDetailScreenState extends ConsumerState<TravelDetailScreen> with WidgetsBindingObserver {
  ...
  void _validateCountryInfo() {
    ...
    updatedDayDataMap.forEach((dateKey, dayData) {
      ...
      if (dayData.countryName.isNotEmpty && !currentTravel.destination.contains(dayData.countryName)) {
                  ...
                  child: Row(
                    children: [
                      ...
                      B2bText.medium(
                        ...
                        text: '${DateUtil.formatDate(travel.startDate)} - ${DateUtil.formatDate(travel.endDate)}',
                      ),
                    ],
                  ),
                ),
                          ...
                          child: Center(
                            child: Row(
                              children: [
                                ...
                                if (displayDay.countryName.isNotEmpty) ...[
                                  const SizedBox(width: 4),
                                  Text(displayDay.flagEmoji),
                                ],
                              ],
                            ),
                          ),
                ...
                Expanded(
                  child: PageView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final updatedDayData = ref.watch(dayDataProvider(dayData.date)) ?? dayData;
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      B2bText.bold(
                                        type: B2bTextType.title3,
                                        text: DateUtil.formatDateWithDay(updatedDayData.date),
                                      ),
                                      if (updatedDayData.countryName.isNotEmpty)
                                        Row(
                                          children: [
                                            Text(updatedDayData.flagEmoji, style: const TextStyle(fontSize: 16)),
                                            const SizedBox(width: 4),
                                            B2bText.regular(
                                              type: B2bTextType.body2,
                                              text: updatedDayData.countryName,
                                            ),
                                          ],
                                        ),
                                    ],
                                ...
                                ElevatedButton.icon(
                                  onPressed: () => _navigateToSchedule(updatedDayData.date, updatedDayData.dayNumber),
                                ...
                                : ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return Card(
                                        ...
                                        child: InkWell(
                                          borderRadius: BorderRadius.circular(12),
                                          onTap: () => _navigateToSchedule(updatedDayData.date, updatedDayData.dayNumber),
                                          child: Padding(
                                            padding: const EdgeInsets.all(16),
                                            child: Row(
                                              crossAxisAlignment: CrossAxisAlignment.start,
