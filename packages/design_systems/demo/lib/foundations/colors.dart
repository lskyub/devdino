    ...
    child: Column(
      ...
      children: [
        ...
        ...group(
            'Grayscale',
            [
              $b2bToken.color.gray100.resolve(context),
              $b2bToken.color.gray200.resolve(context),
              $b2bToken.color.gray300.resolve(context),
              $b2bToken.color.gray400.resolve(context),
              $b2bToken.color.gray500.resolve(context),
              $b2bToken.color.gray600.resolve(context),
              $b2bToken.color.gray700.resolve(context),
            ],
            [
              '50',
              '100',
